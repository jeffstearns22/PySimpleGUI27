...
data_entry_column = [
    ...
    [
        sg.Checkbox("DHSYL2", default = False, text_color="red"),
    ],
    [
        sg.Checkbox("DDD1", default = True, text_color="green"),
    ],
    [
        sg.Checkbox("DDD2", default = False, text_color="red"),
    ],
    [
        sg.Checkbox("GYRO", default = True, text_color="green"),
    ],
    [
        sg.Checkbox("OUTPUT FILE FORMAT PCAP", default = False),
    ],
    [
